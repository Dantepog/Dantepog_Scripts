...
dofile(reaper.GetResourcePath().."/Scripts/Dantepog Scripts/AssetsOrganization/Functions/AssetsOrganization_Functions.lua")

-- Load the graphical interface from the interface script
dofile(reaper.GetResourcePath().."/Scripts/Dantepog Scripts/AssetsOrganization/Functions/AssetsOrganization_GUI.lua")


-- Variables globales
ScriptVersion = "1.01"
ScriptName = 'Assets Organization'
local storageFile = reaper.GetResourcePath().."/Scripts/Dantepog Scripts/AssetsOrganization/Functions/AssetsOrganization_Storage.lua"
